...
//C:\xampp\htdocs\library_management_system\vendor\phpmailer\phpmailer\src\PHPMailer.php:1982 Stack trace: #0 
//C:\xampp\htdocs\library_management_system\vendor\phpmailer\phpmailer\src\PHPMailer.php(1653): PHPMailer\PHPMailer\PHPMailer->smtpSend('Date: Thu, 4 Au...', '\r\n\t\t\t <p>Thank ...') #1 C:\xampp\htdocs\library_management_system\vendor\phpmailer\phpmailer\src\PHPMailer.php(1491): PHPMailer\PHPMailer\PHPMailer->postSend() #2 C:\xampp\htdocs\library_management_system\user_registration.php(210): PHPMailer\PHPMailer\PHPMailer->send() #3 {main} thrown in C:\xampp\htdocs\library_management_system\vendor\phpmailer\phpmailer\src\PHPMailer.php on line 1982
...
if(isset($_POST["register_button"]))
{
	...
	if($message == '')
	{
		...
		//	$mail->send();
//changed line $success = 'Verification Email sent to ' . $formdata['user_email_address'] . ', so before login first verify your email';
			$success = 'Registration Sucessfull with Mail id :' . $formdata['user_email_address'] . ', you can proceed with your Email';
		}
