...
<div class="d-flex align-items-center justify-content-center" style="min-height:700px;">
	...
	<div class="col-md-6" style="min-height:350px;">
		...
		<div class="card border border-dark" style="border-width: thin medium thick;">

			<div class="card-header fs-1"style="background-color:" >Admin Login</div>
			...
			<div class="card-body">
				...
				<form method="POST">
					...
					<div class="mb-3">
						<label class="form-label" style="background-color:">Email address</label>
					...
					<div class="mb-3">
						<label class="form-label" style="background-color:">Password</label>
